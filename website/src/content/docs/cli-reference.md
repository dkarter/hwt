...
- `hwt url NAME [branch] [--json, --open]` resolves any configured named URL. `hwt url --json` resolves every available name and omits PR-dependent URLs when the branch has no pull request.
